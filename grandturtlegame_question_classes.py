...
class Start_Card_Settings:
    def __init__(self, ctx, gamename='Current Game Name', keyname='Current Key Name', step_number=1, steps=1, cooldown=5, timer=5):
        self.ctx = ctx
...
class Choose_One_Card_Settings:
    def __init__(self, ctx, gamename='Current Game Name', keyname='Current Key Name', step_number=1, steps=1, cooldown=5, timer=5, question_description = True):
        self.ctx = ctx
...
class Text_Card_Settings:
    def __init__(self, ctx, gamename='Current Game', keyname='Current Key', step_number=1, steps=1, cooldown=5, timer=5, question_description = True):
        self.ctx = ctx
        self.card_type = 'text'
        self.gamename = gamename
        self.keyname = keyname
